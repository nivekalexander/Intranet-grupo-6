  ...
  <div class="modal-dialog" role="document">
	  <div class="modal-content">
			<div class="modal-header Color-Slidebar">
				<h5 class="modal-title dropdown-text-color" id="titletipjornada">Crear tipo de jornada</h5>
			...
			<div class="modal-body espaciado">		
					...
					<form name="formulario" id="formulario" class="needs-validation" novalidate>
						...
						<div class="modal-footer">
								<button type="button" class="btn btn-gris" data-dismiss="modal" onclick="CancelarTipoJornada();">Cerrar</button>
