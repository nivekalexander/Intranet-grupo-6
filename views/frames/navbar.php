    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header Color-Slidebar">
          <h5 class="modal-title dropdown-text-color" id="exampleModalLabel">¿Quieres cerrar sesión?</h5>
          <button class="close dropdown-text-color" type="button" data-dismiss="modal" aria-label="Close">
